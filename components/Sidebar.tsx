    ...
    return (
        <section className='sidebar'>
            <nav className="flex flex-col gap-4">
                <Link href={'/'} className='flex items-center gap-2 cursor-pointer mb-12'>
                ...
                </Link>
                {
                    sidebarLinks.map((item) => {
                        ...
                        return (
                            <Link href={item.route} key={item.route} className={cn('sidebar-link', { 'bg-bankGradient': isActive })}>
